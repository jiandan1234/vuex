      ...
      <div class="con">
        ...
        <div class="sp-search">
          ...
          <form>
            <span>标题:</span>
            <label for="inputBox">
              <input type="text" class="inp" placeholder="标题" v-model="obj.title" />
            </label>
            <span>发布人:</span>
            <label for="inputBox">
              <input type="text" class="inp" placeholder="发布人" v-model="obj.fabu" />
            </label>
            <span>发布时间:</span>
            <label for="inputBox">
        ...
        <div class="button-con">
          ...
          <button @click.prevent="add()" class="btn">新增</button>
        </div>
      </div>
    </div>
    <!-- 下部分内容部分 -->
...
export default {
  data() {
    ...
    return {
      ...
      list: [
        { title: "标题", fabu: "发布人", date: "发布日期", id: 1 }
        //  { title: "标题", fabu: "发布人", date: "发布日期",id:2 },
        //  { title: "标题", fabu: "发布人", date: "发布日期",id:3 },
        //  { title: "标题", fabu: "发布人", date: "发布日期",id:7 },
      ],
      // 编辑数据
      editData: {},
      tableData: [
  ...
  methods: {
    add() {
      // 必填的判断条件
      if (!this.obj.title || !this.obj.fabu || !this.obj.date) return;
      var _id =
        Math.max(
